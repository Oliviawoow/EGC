...
void Laborator2::Init()
{
	...
	// Create a mesh box using custom data
	{
		...
		meshes["patratel"] = new Mesh("generated patratel");
		meshes["patratel"]->InitFromData(vertices3, indices3);
...
void Laborator2::Update(float deltaTimeSeconds)
{
	...
	RenderMesh(meshes["tetraedru"], shaders["VertexColor"], glm::vec3(0.0f, 0.0f, 0.3), glm::vec3(0.25f));
	RenderMesh(meshes["patratel"], shaders["VertexColor"], glm::vec3(0.5f, 0.5f, 0.2), glm::vec3(0.25f));
